...
const getToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (refresh === exceptionMessage_1.default.TOKEN_EXPIRED) {
            return res
                .status(statusCode_1.default.UNAUTHORIZED)
                .send(BaseResponse_1.default.failure(statusCode_1.default.UNAUTHORIZED, responseMessage_1.default.EXPIRED_REFRESH_TOKEN));
        }
        ...
        const data = {
            accessToken: jwtHandler_1.default.sign(user._id, user.email),
