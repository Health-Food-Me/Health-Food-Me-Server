...
const scrapRestaurant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const restaurantIds = yield UserService_1.default.scrapRestaurant(userId, restaurantId);
        if (!restaurantIds) {
            return res
...
const getHasReviewed = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const restaurantId = req.params.restaurantId;
    try {
        const hasReview = yield UserService_1.default.hasReviewed(userId, restaurantId);
        const data = {
            hasReview: hasReview,
        };
        return res
