...
router.get("/:userId/scrapList", auth_1.default, controllers_1.UserController.getUserScrapList);
...
router.get("/check/:userId/:restaurantId", auth_1.default, controllers_1.UserController.getHasReviewed);
