...
const getAroundRestaurants = (longitude, latitude, zoom, category) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (category) {
            try {
                const result = yield Category_1.default.findOne({ title: { $eq: category } });
                if (result) {
                    query.push({
...
const getRestaurantCardList = (longtitude, latitude, keyword) => __awaiter(void 0, void 0, void 0, function* () {
    try {
